...
I study as a junior majoring in telecommunication at school of ISE at Shandong University(山东大学信息科学与工程学院) and I also work as a research assistant at IR Lab in school of computer science（山东大学计算机科学与技术学院） for over a year, advised by Prof. Pengjie Ren(任鹏杰) and Prof. Xinxin(辛鑫).

My research interest includes recommender system, machine learning and deep learning. I have submitted a paper as a second author (on review) and there are two papers in progress. two patents. 
